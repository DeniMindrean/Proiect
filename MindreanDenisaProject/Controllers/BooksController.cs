...
namespace MindreanDenisaProject.Controllers
{
    ...
    public class BooksController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ID,PublisherID,Title,Author,Price")] Book book)
        {
            try
            {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,PublisherID,Title,Author,Price")] Book book)
        {
            if (id != book.ID)
            {
                return NotFound();
